...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var OTU_ids_top = bacteria.otu_ids.slice(0,10);
    var OTU_labels_top = bacteria.otu_labels.slice(0,10).reverse();
    var sample_values_top = bacteria.sample_values.slice(0,10).reverse();
    var yticks = OTU_ids_top.map(num => "OTU" + num).reverse();
    console.log(yticks);
    console.log(sample_values_top);
    console.log(OTU_labels_top);
